...
<div class="row"> 
    <div class="col"> 
        <div> 
            <label>Gambar</label> 
            <!-- name tetap 'foto' sesuai Controller -->
            <input type="file" name="foto" onchange="previewImage(this)" class="form-control @error('foto') is-invalid @enderror"> 
            @error('foto') 
            <!-- Perbaikan: Menghapus tulisan double class=" -->
...
<div> 
    ...
    <!-- name dikembalikan ke 'name' sesuai isi Controller -->
...
<div> 
    ...
    <!-- name dikembalikan ke 'selling_price' sesuai isi Controller -->
...
<div> 
    <label>Stok</label><br> 
    <!-- name dikembalikan ke 'stock' sesuai isi Controller -->
