        ...
        <table class="table align-middle"> 
            ...
            <tbody> 
                ...
                <tr> 
                    ...
                    {{-- SAMAIN FOTO: Murni memanggil tag img polosan tanpa helper asset() agar memicu ikon broken image kecil persis seperti di modul --}}
                    <td> 
                        <img src="{{ $product->foto }}" width="30" height="30">
                    </td> 
                ...
                {{-- PERBAIKAN: Menghapus d-flex pada td, dan memindahkannya ke div dalam agar tombol terangkat naik ke tengah --}}
                    ...
                    <div class="d-flex align-items-center gap-1 py-1">
                        ...
                        @can('delete', $product) 
                            ...
                            <form action="{{ route('produk.destroy', $product->id) }}" method="POST" class="d-inline m-0"> 
                                @csrf 
                                @method('DELETE') 
                                <button class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin akan menghapus produk ini?')"> Hapus </button> 
                            </form> 
                        @endcan 
                    </div>
                </td>
